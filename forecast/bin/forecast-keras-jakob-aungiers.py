...
def build_model(features, feature_dimensions, layer_dimensions):
    """Build an LSTM model.

    Args:
        Features: Number of features per vector
        feature_dimensions: Dimension of features (Number of rows per feature)
        layer_dimensions: I dunno
...
def main():
    ...
    model = build_model(features, feature_dimensions, layer_dimensions)
    model.fit(
        x_train,
        y_train,
